...
def iterate_datasets(data_names, cache_dir):
    ...
    for data_name in data_names:
        if data_name in ['cora', 'citeseer', 'pubmed']:
            data = Planetoid(root=cache_dir, name=data_name.capitalize()).data
        elif data_name in ['wisconsin', 'texas', 'cornell']:
            data = WebKB(root=cache_dir, name=data_name.capitalize()).data
        elif data_name in ['computers', 'photo']:
            data = Amazon(root=cache_dir, name=data_name.capitalize()).data
            ...
            data = WikipediaNetwork(root=cache_dir, name=data_name.capitalize(), geom_gcn_preprocess=True).data
